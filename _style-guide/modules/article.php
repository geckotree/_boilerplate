<div class="wrap--site">
	<main class="main-content">
		<article class="article" itemscope itemtype="http://schema.org/Article">
			...
			<div class="wrap--content" itemprop="articleBody">
				...
				<ul>
					<li>downloading and parsing <abbr title="Hyper Text Markup Language">HTML</abbr>, <abbr title="Cascading Style Sheets">CSS</abbr> and <abbr title="JavaScript">JS</abbr></li>
