...
<div class="section-padding--lr">
	<div class="wrap two-col clearfix">
		<main class="main-content section-padding--tb">
			<article class="article" itemscope itemtype="http://schema.org/Article">
				<header class="article__header">
					<h1 class="article__heading" itemprop="name">Optimising for <a href="">60fps</a> everywhere</h1>
