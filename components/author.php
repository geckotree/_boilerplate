...
<footer class="article__footer section-padding--tb section-padding--lr" itemscope itemtype="http://schema.org/Person">
	<div class="wrap__inner clearfix">
		<figure class="article__footer__figure">
			<picture>
				<img src="http://placehold.it/250x250" srcset="http://placehold.it/375x375 2x" alt="A view of the pulpit rock in Norway" itemprop="image">
			</picture>
		</figure>
