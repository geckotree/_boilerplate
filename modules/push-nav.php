		...
		<main class="main-content" role="main">
			<article class="article" itemscope itemtype="http://schema.org/Article">
				<header class="article__header">
					<h1 class="article__heading tera" itemprop="name">Mobile &amp; touch <a href="">drawer</a> navigation</h1>
					<button class="button--primary" data-toggle="nav--main">Toggle menu</button>
				</header>
